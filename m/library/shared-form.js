...
var part_id1=$vm.module_list[m.prefix+'participant-data'].participant_id.field1;
var part_id2=$vm.module_list[m.prefix+'participant-data'].participant_id.field2;
var part_id3=$vm.module_list[m.prefix+'participant-data'].participant_id.field3;
var autocomplete_req_p={cmd:"find",table:$vm.module_list[m.prefix+'participant-data'].Table,options:{},skip:0,limit:10}
